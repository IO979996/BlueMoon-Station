...
GLOBAL_LIST_INIT(lawlorify, populate_lawlorify())

/proc/populate_lawlorify()
	var/list/lore = list()
	lore[OBLIGATION_FOOD] = "This devil seems to always offer its victims food before slaughtering them."
	lore[OBLIGATION_FIDDLE] = "This devil will never turn down a musical challenge."
	lore[OBLIGATION_DANCEOFF] = "This devil will never turn down a dance off."
	lore[OBLIGATION_GREET] = "This devil seems to only be able to converse with people it knows the name of."
	lore[OBLIGATION_PRESENCEKNOWN] = "This devil seems to be unable to attack from stealth."
	lore[OBLIGATION_SAYNAME] = "He will always chant his name upon killing someone."
	lore[OBLIGATION_ANNOUNCEKILL] = "This devil always loudly announces his kills for the world to hear."
	lore[OBLIGATION_ANSWERTONAME] = "This devil always responds to his truename."
	lore[BANE_SILVER] = "Silver seems to gravely injure this devil."
	lore[BANE_SALT] = "Throwing salt at this devil will hinder his ability to use infernal powers temporarily."
	lore[BANE_LIGHT] = "Bright flashes will disorient the devil, likely causing him to flee."
	lore[BANE_IRON] = "Cold iron will slowly injure him, until he can purge it from his system."
	lore[BANE_WHITECLOTHES] = "Wearing clean white clothing will help ward off this devil."
	lore[BANE_HARVEST] = "Presenting the labors of a harvest will disrupt the devil."
	lore[BANE_TOOLBOX] = "That which holds the means of creation also holds the means of the devil's undoing."
	lore[BAN_HURTWOMAN] = "This devil seems to prefer hunting men."
	lore[BAN_CHAPEL] = "This devil avoids holy ground."
	lore[BAN_HURTPRIEST] = "The annointed clergy appear to be immune to his powers."
	lore[BAN_AVOIDWATER] = "The devil seems to have some sort of aversion to water, though it does not appear to harm him."
	lore[BAN_STRIKEUNCONSCIOUS] = "This devil only shows interest in those who are awake."
	lore[BAN_HURTLIZARD] = "This devil will not strike a lizardman first."
	lore[BAN_HURTANIMAL] = "This devil avoids hurting animals."
	lore[BANISH_WATER] = "To banish the devil, you must infuse its body with holy water."
	lore[BANISH_COFFIN] = "This devil will return to life if its remains are not placed within a coffin."
	lore[BANISH_FORMALDYHIDE] = "To banish the devil, you must inject its lifeless body with embalming fluid."
	lore[BANISH_RUNES] = "This devil will resurrect after death, unless its remains are within a rune."
	lore[BANISH_CANDLES] = "A large number of nearby lit candles will prevent it from resurrecting."
	lore[BANISH_DESTRUCTION] = "Its corpse must be utterly destroyed to prevent resurrection."
	lore[BANISH_FUNERAL_GARB] = "If clad in funeral garments, this devil will be unable to resurrect.  Should the clothes not fit, lay them gently on top of the devil's corpse."

	var/list/law = list()
	law[OBLIGATION_FOOD] = "When not acting in self defense, you must always offer your victim food before harming them."
	law[OBLIGATION_FIDDLE] = "When not in immediate danger, if you are challenged to a musical duel, you must accept it.  You are not obligated to duel the same person twice."
	law[OBLIGATION_DANCEOFF] = "When not in immediate danger, if you are challenged to a dance off, you must accept it. You are not obligated to face off with the same person twice."
	law[OBLIGATION_GREET] = "You must always greet other people by their last name before talking with them."
	law[OBLIGATION_PRESENCEKNOWN] = "You must always make your presence known before attacking."
	law[OBLIGATION_SAYNAME] = "You must always say your true name after you kill someone."
	law[OBLIGATION_ANNOUNCEKILL] = "Upon killing someone, you must make your deed known to all within earshot, over comms if reasonably possible."
	law[OBLIGATION_ANSWERTONAME] = "If you are not under attack, you must always respond to your true name."
	law[BAN_HURTWOMAN] = "You must never harm a female outside of self defense."
	law[BAN_CHAPEL] = "You must never attempt to enter the chapel."
	law[BAN_HURTPRIEST] = "You must never attack a priest."
	law[BAN_AVOIDWATER] = "You must never willingly touch a wet surface."
	law[BAN_STRIKEUNCONSCIOUS] = "You must never strike an unconscious person."
	law[BAN_HURTLIZARD] = "You must never harm a lizardman outside of self defense."
	law[BAN_HURTANIMAL] = "You must never harm a non-sentient creature or robot outside of self defense."
	law[BANE_SILVER] = "Silver, in all of its forms shall be your downfall."
	law[BANE_SALT] = "Salt will disrupt your magical abilities."
	law[BANE_LIGHT] = "Blinding lights will prevent you from using offensive powers for a time."
	law[BANE_IRON] = "Cold wrought iron shall act as poison to you."
	law[BANE_WHITECLOTHES] = "Those clad in pristine white garments will strike you true."
	law[BANE_HARVEST] = "The fruits of the harvest shall be your downfall."
	law[BANE_TOOLBOX] = "Toolboxes are bad news for you, for some reason."
	law[BANISH_WATER] = "If your corpse is filled with holy water, you will be unable to resurrect."
	law[BANISH_COFFIN] = "If your corpse is in a coffin, you will be unable to resurrect."
	law[BANISH_FORMALDYHIDE] = "If your corpse is embalmed, you will be unable to resurrect."
	law[BANISH_RUNES] = "If your corpse is placed within a rune, you will be unable to resurrect."
	law[BANISH_CANDLES] = "If your corpse is near lit candles, you will be unable to resurrect."
	law[BANISH_DESTRUCTION] = "If your corpse is destroyed, you will be unable to resurrect."
	law[BANISH_FUNERAL_GARB] = "If your corpse is clad in funeral garments, you will be unable to resurrect."

...
/datum/techweb_node/adv_datatheory
	...
	design_ids = list("icprinter", "bounty_pad","bounty_pad_control", "encryptionkey_sec", "encryptionkey_eng", "encryptionkey_med", "encryptionkey_medsci", "encryptionkey_sci", "encryptionkey_cargo", "encryptionkey_mining", "encryptionkey_service")

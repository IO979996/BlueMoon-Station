...
/datum/design/component_printer_circuit
	name = "Circuit component fabricator (machine board)"
	desc = "Machine board for a fabricator that prints modular circuit components (wiremod)."
	id = "icprinter"
	build_type = PROTOLATHE
